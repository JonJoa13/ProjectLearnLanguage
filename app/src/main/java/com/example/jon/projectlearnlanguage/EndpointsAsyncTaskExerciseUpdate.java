...
public class EndpointsAsyncTaskExerciseUpdate extends AsyncTask<Void, Void, List<Exercise>> {
    private static ExerciseApi exerciseApi = null;
    private static final String TAG = EndpointsAsyncTaskExercise.class.getName();
    private Exercise exercise;

    EndpointsAsyncTaskExerciseUpdate(){}

    public EndpointsAsyncTaskExerciseUpdate(Exercise exercise){
    ...
    protected List<Exercise> doInBackground(Void... params) {
        ...
        try{
            ...
            // For instance insert
            if(exercise != null){
                exerciseApi.update(exercise.getId(),exercise).execute();
